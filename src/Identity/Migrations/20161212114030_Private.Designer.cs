...
namespace Identity.Migrations
{
    ...
    [Migration("20161212114030_Private")]
    partial class Private
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Identity.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("GitRepoRepoKey");
            ...
            modelBuilder.Entity("Identity.Models.ApplicationUser", b =>
                {
                    b.HasOne("Identity.Models.GitRepo")
                        .WithMany("AllowedUser")
                        .HasForeignKey("GitRepoRepoKey");
                });
